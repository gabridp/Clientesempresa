...
using ApiClientesEmpresa.Service.Authentication;
using ApiClientesEmpresa.Service.Requests;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace ApiClientesEmpresa.Services.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Post(LoginPostRequest request)
        {
            try
            {
                //buscando o usuário no banco de 
                //dados através do email e senha
                var usuario = _usuarioRepository.Get(request.Email, Criptografia.Get(request.Senha, Criptografia.Hash.SHA1));
